                    ...
                    Rectangle {
                        ...
                        Column {
                            ...
                            Row {
                                ...
                                ComButton {
                                    text: "重置"
                                    onClicked: loadUSets(txtLength, "fbarcodeURL")
                                }
                                ...
                                Rectangle {
                                    ...
                                    ComButton {
                                        ...
                                        text: "保存"
                                        onClicked: {
                                            saveUSets(txtLength, "fbarcodeURL")
                                            btnSaveIconShowAni.start()
                                        }
                                        opacity: 1
                                    }
                        ...
                        Component.onCompleted: loadUSets(txtLength, "fbarcodeURL")
                    }
                }
            }
                    ...
                    Rectangle {
                        ...
                        Column {
                            ...
                            Row {
                                ...
                                ComButton {
                                    text: "重置"
                                    onClicked: loadUSets(txtLength, "startUpParamsURL")
                                }
                                ...
                                Rectangle {
                                    ...
                                    ComButton {
                                        ...
                                        text: "保存"
                                        onClicked: {
                                            saveUSets(txtLength, "startUpParamsURL")
                                            btnSaveIconShowAni.start()
                                        }
                                        opacity: 1
                                    }
                        ...
                        Component.onCompleted: loadUSets(txtLength, "startUpParamsURL")
                    }
                }
            }
